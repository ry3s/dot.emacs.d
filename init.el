...
(custom-set-variables
 ...
 '(package-selected-packages
  (quote
   (prop-menu proof-general doom-themes use-package magit projectile intero yaml-mode haskell-mode company-ghc company-ghci yatex json-mode counsel ivy flycheck-elm flycheck elm-mode exec-path-from-shell cargo rust-mode multi-term sml-mode madhat2r-theme company)))
 '(sml-indent-level 2))
(custom-set-faces
...
;; (set-face-foreground 'font-lock-comment-face "#888f90")
